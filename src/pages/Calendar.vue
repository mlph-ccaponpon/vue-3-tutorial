<template>
    <div class="m-auto">
        <h1 class="text-3xl text-center my-2">Vue Calendar</h1>
        <section class="flex justify-between">
            <h2 class="text-2xl font-bold">{{ currentMonthName }}</h2>
            <h2 class="text-2xl font-bold mx-2">{{ currentYear }}</h2>
        </section>
...
export default {
    ...
    methods: {
        ...
        currentDateClass(num) {
            ...
            return calendarDate === currDate ? "text-yellow-600":""
        }
    },
    computed: {
        currentMonthName() {
